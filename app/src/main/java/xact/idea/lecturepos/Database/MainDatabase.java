...
@Database(entities = {Customer.class, Book.class, SalesDetails.class, SalesMaster.class, Login.class, Challan.class, Sync.class, ChallanDetails.class, BookStock.class}, version =3,exportSchema = false)
