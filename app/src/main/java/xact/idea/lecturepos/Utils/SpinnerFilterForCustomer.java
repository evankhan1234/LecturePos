...
public class SpinnerFilterForCustomer extends Filter {
    private List<String> items ;
    private CustomerListAdadpter adapter;

    public SpinnerFilterForCustomer(List<String> filterList, CustomerListAdadpter adapter) {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adapter.item = (ArrayList<String>) results.values;
